...
import { FetchBoardData } from "../hooks/fetch-board";
...
export const Board = (props) => {
    ...
    const addAllStoriesToBoard = () => {
        BoardService.addAllStoriesToBoard(boardId).then(
            (response) => {
                if (response == true) {
                    reloadPage();
                } else {
                    setOperationError("Error adding all stories to board");
                }
            }
        )
    ...
    const checkIfColumnsGotCards = (columnsToCheck) => {
        let gotCards = false;
    ...
    return (
        operationError ?
            ...
            columns ?
                <div className="board">
                    <div>
                        {checkIfColumnsGotCards(columns) == false ?
                            <Button className="add-all-stories-button" onClick={addAllStoriesToBoard}>Add All Stories</Button> : null
                        }
                    </div>
