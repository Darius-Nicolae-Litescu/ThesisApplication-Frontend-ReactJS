    ...
    return (
      ...
      >
        ...
        >
          <Card.Body
            style={{
              background: this.props.story.isFinished ? "crimson" : "#00008B",
              color: "white",
            }}
          >
            <div className="card-block px-2">
              ...
              <h3 className="subtitle">
                Created by username: {this.props.story.createdBy.username}
              </h3>
              <h3 className="subtitle">
                Email: {this.props.story.createdBy.email}
              </h3>
              <div className="p-4">
                <p className="uppercase tracking-wide text-sm font-bold text-gray-700">
                  {this.props.story.isFinished
                    ? "Status: Finished"
                    : "Status: Not finished"}
                </p>

                <p className="text-3xl text-gray-900">
                  Total points: {this.props.story.totalStoryPoints}
                </p>
              </div>
