...
import { ListGroup, DropdownButton, ButtonGroup, Dropdown } from 'react-bootstrap'

import './sidebar.css';


export const SelectCategories = (props) => {
    const { sectionSelected: sectionSelected, setSectionSelected: setSectionSelected,
        selectedCategory: selectedCategory, setSelectedCategory: setSelectedCategory,
        selectedOperation: selectedOperation, setSelectedOperation: setSelectedOperation,
        optionsData: optionsData } = props;
