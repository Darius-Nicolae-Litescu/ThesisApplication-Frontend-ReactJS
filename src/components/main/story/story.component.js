...
function App() {
  ...
  function changeDetails() {
    setCurrentError();
    StoryService.updateStoryTitleAndDescription(
      storyId,
      title,
      description
    ).then(
        ...
        <>
          <StoryGeneralInfo
            ...
            storyGeneralInfo={{
              ...
              softwareApplication: data.softwareApplication,
            ...
            <Card bg="light" text="dark" style={{ width: "100%" }}>
              <Container>
                <div id="outer">
                  <div className="inner">
                    <Button
                      className="add-story-task-button"
                      onClick={redirectToAddStoryTask}
                    >
                      Add new Story Task
                    </Button>{" "}
                  </div>
              ...
              <Card.Body>
                ...
                <div className="card-block px-2">
                  <Card.Title style={{ maxHeight: "20%", overflow: "auto" }}>
                    <SubtaskList
                      storySubtasks={data.storySubtasks}
                    ></SubtaskList>
                  </Card.Title>
                  <Card.Title>
                    <Card.Footer>
