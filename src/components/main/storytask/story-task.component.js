            ...
            {status === 'fetched' && (
                <>
                    <StoryGeneralInfo updateData={updateData} storyGeneralInfo={{
                        storyTaskId: storyTaskId, createdByUsername: data.createdByUsername, assignedToUsername: data.assignedToUsername, finishedAt: data.finishedAt,
                        status: data.status, storyPoints: data.storyPoints
                    }}></StoryGeneralInfo>
                    <Container style={{ width: '100%', height: '100%' }}>
                        ...
                        >
                            ...
                            <div style={{ "display": "grid" }} className="media-body p-2 shadow-sm rounded bg-light border">
                                <input className="story-task-title" onChange={e => setTitle(e.target.value)} value={title} disabled={!isEditActive} />
