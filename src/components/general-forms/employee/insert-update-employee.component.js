                ...
                <Form className="employee-form" onSubmit={handleSubmit}>
                    {employeeId &&
                        <Form.Group controlId="employeeId">
                            ...
                            <Form.Control type="text" name="employeeId" value={employeeId} readOnly />
                        </Form.Group>
                    }
                    <Form.Group controlId="personId">
                        <Form.Label>Person Id</Form.Label>
                        <Form.Control type="text" name="personId" value={personId} onChange={(event) => setPersonId(event.target.value)}/>
                    </Form.Group>
                    <Form.Group controlId="positionId">
                        <Form.Label>Position Id</Form.Label>
                        <Form.Control type="text" name="positionId" value={positionId} onChange={(event) => setPositionId(event.target.value)}/>
                    </Form.Group>
                    <Form.Group controlId="userId">
                        <Form.Label>User Id</Form.Label>
                        <Form.Control type="text" name="userId" value={userId} onChange={(event) => setUserId(event.target.value)}/>
                    </Form.Group>
                    <br />
                    <button type="submit" className="btn btn-primary">{employeeId ? "Update employee" : "Add employee"}</button>
                    <br />
                </Form>
            }
        </Container>
