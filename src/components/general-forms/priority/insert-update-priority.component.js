                ...
                <Form className="priority-form" onSubmit={handleSubmit}>
                    {priorityId &&
                        <Form.Group>
                            ...
                            <Form.Control required disabled as="select" className="form-control" id="priorityId" aria-describedby="priorityIdHelp">
                    ...
                    <Form.Group>
                        ...
                        <Form.Control required type="text" className="form-control" id="title" placeholder="Enter title" name="title" value={title} onChange={(event) => setTitle(event.target.value)} />
                    </Form.Group>
                    <Form.Group>
                        <Form.Label htmlFor="description">Description</Form.Label>
                        <Form.Control required type="text" className="form-control" id="description" placeholder="Enter description" name="description" value={description} onChange={(event) => setDescription(event.target.value)} />
                    </Form.Group>
                    <Form.Group>
                        <Form.Label htmlFor="level">Level</Form.Label>
                        <Form.Control required type="number" className="form-control" id="level" placeholder="Enter level" name="level" value={level} onChange={(event) => setLevel(event.target.value)} />
                    </Form.Group>
                    <Form.Group>
                        <br />
                        <button type="submit" className="btn btn-primary">{priorityId ? "Update priority" : "Add priority"}</button>
                        <br />
                    </Form.Group>
                </Form>
            }
