    ...
    <Container>
      ...
      <Form className="add-story-form" onSubmit={handleSubmit}>
        <Form.Group>
          ...
          <small id="storyHelp" className="form-text text-muted">
            Story task for story id
          </small>
        </Form.Group>
        <Form.Group>
          ...
          <small id="titleHelp" className="form-text text-muted">
            Enter the title of the story task
          </small>
        </Form.Group>
        <Form.Group>
          ...
          <small id="descriptionHelp" className="form-text text-muted">
            Enter the description of the story task
          </small>
        </Form.Group>
        <Form.Group>
          ...
          />
          <small id="storyPointsHelp" className="form-text text-muted">
            Enter the story points of story task
          </small>
        </Form.Group>
        <Form.Group>
          ...
          <small id="statusHelp" className="form-text text-muted">
            Enter the status of the story task
          </small>
        </Form.Group>
